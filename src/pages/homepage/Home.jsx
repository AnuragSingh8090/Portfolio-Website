...
const Home = () => {
  return (
    <>    
      <div className="mainContainer hidden lg:block pb-[60px] lg:pb-0 w-full  lg:h-[90%] lg:w-[85%]  lg:rounded-2xl lg:overflow-hidden pageAnimation" >
        <div className="header bg-[#111a16] sticky z-[99]  top-0 left-0 lg:static py-5 lg:py-0 lg:h-[14%] gap-3 flex items-center justify-between px-4">
          <div className="shrink-0">
            ...
            <p className="text-[1.2vw]  mt-2 text-[#9f9fa8]">
             Frontend Developer building high-performance, user-centric digital experiences at <span className="text-[#64f196]">1EQ Edutech Private Limited</span>
            </p>
          </div>
          
          <div className="flex items-center  gap-[3vw]">

            <a  href="/Anurag-resume.pdf" download className="flex items-center whitespace-nowrap gap-[0.3vw] text-[1.2vw] text-[#898989] hover:text-[#d4d4d4]  bg-[#1c2121] border-[1px] border-[#2e3033] cursor-pointer transition-all duration-300 hover:border-[#bebebe] rounded-3xl  px-[0.8vw] py-[0.4vw]">
          ...
          <div className="h-[63%] w-full  flex justify-between gap-4">
            <div className="h-full w-[22%]  flex flex-col justify-between gap-4">
              <div className="h-[80%] w-full rounded-xl maskImage disableDrag cursor-pointer " >
                <img src="/profile-image.webp" alt="" className="w-full h-full object-cover rounded-xl  grayscale hover:grayscale-[none] active:grayscale-[none] transition-all duration-700" />
              </div>
              <Link to='/contact' className="h-[15%] relative w-full overflow-hidden bg-[#18181b] border-[1px] border-[#27272a] rounded-lg shrink-0 cursor-pointer flex items-center justify-center hover:scale-[101%] transition-all duration-300 ">
...
Frontend Developer with professional experience building responsive web applications using React.js, Angular, JavaScript, and 
TypeScript. Experienced in creating reusable UI components, integrating APIs, implementing SEO-friendly frontend practices, and 
converting design systems into scalable interfaces. Focused on writing maintainable code and delivering high-performance user 
experiences across devices.
              ...
              <div className="flex w-full items-center justify-between gap-4 h-[36%] ">
                 <div className="w-1/3 h-full bg-[#27272a] rounded-lg flex flex-col justify-between gap-3 px-4 py-4 hover:scale-[105%] transition-all duration-300 cursor-pointer">
                   ...
                   <p className="text-[1vw] text-[#dfdfdf]">Building responsive UIs with React.js, Angular, Tailwind CSS and Bootstrap.</p>
                 </div>
                 <div className="w-1/3 h-full bg-[#27272a] rounded-lg flex flex-col justify-between gap-3 px-4 py-4 hover:scale-[105%] transition-all duration-300 cursor-pointer">
                   <p className="flex items-center">
                   ...
                   <p className="text-[1vw] text-[#dfdfdf]">
  Clutching intense fights and chasing chicken dinners in BGMI. 🏆🔥
</p>
                 </div>
                 <div className="w-1/3 h-full bg-[#27272a] rounded-lg flex flex-col justify-between gap-3 px-4 py-4 hover:scale-[105%] transition-all duration-300 cursor-pointer">
                   <p className="flex items-center">
             ...
             <div className="flex items-center w-full h-full justify-between text-[1.2vw] tracking-[1px] font-[300]  gap-3">
                <div className="flex items-center gap-[0.5vw] ">
                    ...
                    <div className="flex items-center text-[1.1vw] gap-[1.5vw] leading-[1.4vw] px-[0.5vw] ">
                      <div>
                      <p className="text-[#d4d4d8]">name : <span className="text-[#64f196]">"Anurag kumar singh"</span>,</p>
                      ...
                      <div>
                      <p className="text-[#d4d4d8]">expertise : <span className="text-[#64f196]">"Frontend Developer ✨"</span>,</p>
                      <p className="text-[#d4d4d8]">status : <span className="text-[#64f196]">"Building the Next Big Thing"</span>,</p>
                      <p className="text-[#d4d4d8]">experience : <span className="text-[#64f196]">"1 Years"</span>,</p>
                      </div>
